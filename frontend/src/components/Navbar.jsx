...
function Navbar() {
  ...
  return (
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed 
        ...
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <img
              ...
              alt="brand-logo"
              className="sm:w-[120px] sm:h-[50px] w-[100px] h-[40px] cursor-pointer"
            />
          </div>
